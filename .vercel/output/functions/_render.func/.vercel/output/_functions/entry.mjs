import { r as renderers } from './chunks/_id__Cn5uJa7B.mjs';
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_hi5bqIo_.mjs';
import { A as AstroError, o as i18nNoLocaleFoundInPath, p as appendForwardSlash, q as joinPaths, R as ResponseSentError, s as MiddlewareNoDataOrNextCalled, t as MiddlewareNotAResponse, G as GetStaticPathsRequired, u as InvalidGetStaticPathsReturn, v as InvalidGetStaticPathsEntry, w as GetStaticPathsExpectedParams, x as GetStaticPathsInvalidRouteParam, y as trimSlashes, P as PageNumberParamNotFound, z as NoMatchingStaticPathFound, B as PrerenderDynamicEndpointPathCollide, C as ReservedSlotName, L as LocalsNotAnObject, H as PrerenderClientAddressNotAvailable, J as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, K as RewriteWithBodyUsed, Q as AstroResponseHeadersReassigned, T as fileExtension, U as slash, V as prependForwardSlash, W as RewriteEncounteredAnError, X as removeTrailingForwardSlash } from './chunks/astro/assets-service_KEzMZD3y.mjs';
import { R as ROUTE_TYPE_HEADER, g as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, h as renderSlotToString, i as renderJSX, j as chunkToString, k as isRenderInstruction, l as clientLocalsSymbol, n as clientAddressSymbol$1, o as renderPage, p as renderEndpoint, A as ASTRO_VERSION, q as responseSentSymbol$1, t as REROUTABLE_STATUS_CODES } from './chunks/astro/server_vkbS21Jx.mjs';
...
const _page1 = () => import('./pages/api/companyregister/_id_.astro.mjs');
const _page2 = () => import('./pages/api/companyregister.astro.mjs');
const _page3 = () => import('./pages/api/contact/_id_.astro.mjs');
const _page4 = () => import('./pages/api/contact.astro.mjs');
const _page5 = () => import('./pages/api/newsletter.astro.mjs');
const _page6 = () => import('./pages/api/talentregister/_id_.astro.mjs');
const _page7 = () => import('./pages/api/talentregister.astro.mjs');
const _page8 = () => import('./pages/thank-you.astro.mjs');
const _page9 = () => import('./pages/index.astro.mjs');
const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/companyRegister/[id].ts", _page1],
    ["src/pages/api/companyRegister/index.ts", _page2],
    ["src/pages/api/contact/[id].ts", _page3],
    ["src/pages/api/contact/index.ts", _page4],
    ["src/pages/api/newsletter/index.ts", _page5],
    ["src/pages/api/talentRegister/[id].ts", _page6],
    ["src/pages/api/talentRegister/index.ts", _page7],
...
const _args = {
    "middlewareSecret": "8fdc2c79-3671-4a22-9348-a21c5343592c",
